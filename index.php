...
<head>
  ...
  <title>Air Conditioner - Home</title>
...
<body>
  ...
  <div class="hero_area">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="https://serviceclone.com/uploads/category_images/AC-slider_1350_400.jpg" style="height: 37vw;" alt="3">
        </div>
      </div>
  ...
  <section class="about_section layout_padding pt-0">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box" style="margin-right:5%">
            <div class="heading_container">
              <h2>
                <span style="font-size: 20px; float:left; color:#4955a6"> Welcome to </span> <br>
                Bright Air Conditioner
              </h2>
            </div>
            <p style="text-align:justify">
              At <b>BrightAirConditioner</b> we specialize in providing professional and efficient servicing for a wide range
              of home appliances, including air conditioners, refrigerators, water purifiers (RO systems), and geysers.
              Our certified technicians are committed to delivering top-quality solutions tailored to your specific
              needs. We prioritize customer satisfaction, quality workmanship, and prompt service. Whether it’s an
              urgent repair or routine maintenance, we ensure that your appliances are in the best hands. <br> Choose us
              for all your appliance service needs and experience the difference!
            </p>
            <a href="about.php">
              Read More
            </a>
        ...
        <div class="col-md-6">
          <div class="img_container">
            <div class="img-box b1">
              <img src="https://5.imimg.com/data5/SELLER/Default/2023/10/357264599/IA/SM/LL/40917022/ac-amc-service-500x500.png" alt="" />
            </div>
            <div class="img-box b2">
              <img src="https://5.imimg.com/data5/SELLER/Default/2021/9/MR/QK/YY/136633202/single-door-refrigerator-repair-services.jpg" alt="" />
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
              At Bright AirConditioner, we take pride in delivering top-notch appliance repair and maintenance services. Whether it's an AC, refrigerator, RO purifier, geyser, or deep freezer, our expert technicians ensure seamless repairs and reliable performance.
            </p>
            <h4>Why Choose Us ?</h4>
            <ul style="list-style: none;">
              ...
              <li>✔ 24/7 Support & Emergency Services</li>
            </ul>
            <a href="about.php">
              Read More
            </a>
  ...
  <section class="service_section layout_padding2">
    <div class="container">
      ...
      <div class="service_container">
        <div class="box active">
          <div class="img-box">
            <img src="images/ac.png" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
            ...
            <p>
              Professional installation and quick repair services to ensure optimal cooling and efficiency.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          <div class="img-box">
            <img src="images/repair.png" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
            ...
            <p>
              Washing machine repair and maintenance services to keep your appliance running smoothly.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          <div class="img-box">
            <img src="images/fridge.png" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Fridge Maintenance
            ...
            <p>
              Refrigerators are an essential part of every household and commercial kitchen.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          <div class="img-box">
            <img src="images/water-filter.png" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              R.O. Water Filter
            ...
            <p>
              RO water purifier repair and servicing to ensure pure water for your home and office.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          <div class="img-box">
            <img src="images/geyser.png" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Geyser Repair
            ...
            <p>
              We specialize in repairing and servicing all types of geysers.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          <div class="img-box">
            <img src="images/freezer.png" class="img1" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Deep Freezer
            ...
            <p>
              We offer expert deep freezer repair services to prevent food spoilage and costly breakdowns.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          ...
          <div class="detail-box">
            ...
            <p>
              We offer all tyes of home appliances services.
            </p>
          </div>
        </div>
        ...
        <div class="box active">
          ...
          <div class="detail-box">
            ...
            <p>
              We maintain all kinds of home appliances.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <a href="">
              ...
              <span>
                48 Taimoor Nagar NFC, New Delhi <span style="padding-left: 18vw;"> 110065</span>
              </span>
            </a>
          </div>
          <div class="col-md-4">
        ...
        <div class="col-md-6">
          <div class="map_container">
            <div class="map-responsive">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3503.9259124827004!2d77.2641921753787!3d28.571987375697837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce399c985d8bb%3A0xb2bd1bf0a2586f7f!2sBlock%20B%2C%2048%2C%20Taimoor%20Nagar%2C%20New%20Friends%20Colony%2C%20New%20Delhi%2C%20Delhi%20110065!5e0!3m2!1sen!2sin!4v1741589895100!5m2!1sen!2sin"
